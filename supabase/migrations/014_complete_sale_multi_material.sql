-- Update complete_sale RPC to support multiple materials per service line
-- Previously: single "material" object per service
-- Now: "materials" array per service, each inserted as a separate sales_material_entry
